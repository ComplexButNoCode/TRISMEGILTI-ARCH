  ...
  return (
    <footer className="bg-[#F4F4F4]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        ...
        <div id="dialogue" className="text-center mb-20 md:mb-32">
          <h2 className="text-sm font-medium tracking-widest uppercase text-gray-500 mb-6">{t.cta_title}</h2>
          <a 
            href={`mailto:${t.cta_email}`} 
            className="text-4xl md:text-7xl lg:text-8xl text-black font-light hover:underline underline-offset-8 decoration-1 break-all"
          >
            {t.cta_email}
          </a>
        </div>
