      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
          ...
          <div id="about" className="md:w-1/3">
             <h2 className="text-xl font-light text-gray-800 leading-relaxed max-w-xs">
          ...
          <div className="text-center">
            <h3 className="text-sm font-medium tracking-widest uppercase text-gray-500 mb-3">Get in Touch</h3>
            <a href="mailto:studio@trismegilti.com" className="text-lg text-gray-700 font-light hover:text-gray-900 transition-colors">
          ...
          <div className="md:w-1/3 flex flex-col items-start md:items-end">
             <div className="flex justify-center space-x-6 mb-6">
                ...
                <a href="#" className="text-gray-500 hover:text-gray-900 transition-colors" aria-label="Pinterest">
             ...
             <p className="text-sm text-gray-400">&copy; {new Date().getFullYear()} Trismegilti Studio.</p>
          </div>
        </div>
